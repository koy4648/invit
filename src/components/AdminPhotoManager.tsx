  ...
  return (
    <section className="space-y-5">
      ...
      <div
        ...
        style={{ background: "rgba(212,169,106,0.1)", color: "#78716c" }}
      >
      ...
      {isLoading ? (
        ...
        <button
          ...
          style={{ borderColor: "rgba(212,169,106,0.4)", color: "#a8a29e" }}
        >
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          {photos.map((photo, index) => (
            <article
              ...
              style={{ border: "1px solid rgba(212,169,106,0.2)" }}
            >
              <div className="relative aspect-[4/3] bg-stone-100">
                ...
                {photo.isCover && (
                  <span className="absolute left-3 top-3 flex items-center gap-1 rounded-full bg-white/90 px-2.5 py-1 text-xs" style={{ color: "#b08840" }}>
